<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        @endif
        @if($req->input('type')=='64')
            <div class="form-group">
                <label for="hb">Hb [Haemoglobin]</label>
                <input type="hb" @if($req_old->hb)value={{$req_old->hb}}@endif name="hb" class="form-control" id="hb" placeholder="g/dL">
            </div>
        @endif
        @if($req->input('type')=='65')
            <div class="form-group">
                <label for="ppbs">P.P.B.S [Post Parandial Blood Sugar]</label>
                <input type="ppbs" @if($req_old->ppbs)value={{$req_old->ppbs}}@endif name="ppbs" class="form-control" id="ppbs" placeholder="mg/dL">
            </div>
        @endif
        @if($req->input('type')=='66')
            <div class="form-group">
                <label for="rbs">R.B.S [Random Blood Sugar]</label>
                <input type="rbs" @if($req_old->rbs)value={{$req_old->rbs}}@endif name="rbs" class="form-control" id="rbs" placeholder="mg/dL">
            </div>
        @endif
        <br>
        <label>Urine Full Report (U.F.R)</label>
        <div class="form-group">
