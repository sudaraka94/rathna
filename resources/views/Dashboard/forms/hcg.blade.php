<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Pregnancy Test (H.C.G)</h3>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    ...
    <div class="box-body">
        <div class="form-group">
            <label for="hcg">Pregnancy Test (H.C.G)</label>
            <input @if($req_old->hcg)value={{$req_old->hcg}}@endif list="hcg_set" type="text" list="hcg_set" name="hcg" class="form-control" id="hcg" placeholder="">
            <datalist id="hcg_set">
        ...
        <div class="form-group">
            ...
            <div class="input-group date">
                ...
                <input name="repeat" type="text" @if($submit=="edit")value="{{$obj->getPickDate()}}" @endif autocomplete="off" class="form-control pull-right" id="datepicker" placeholder="If don't need, keep empty">
            </div>
        </div>
        @if($req->input('type')=='9')
